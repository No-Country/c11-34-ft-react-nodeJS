...
export function SearchBar() {
  ...
  return (
    <div className="w-full gap-3 flex flex-col mt-5 lg:flex-row lg:border lg:border-border-color lg:rounded-full lg:p-4 lg:w-4/5">
        ...
        <div className='flex flex-row items-center px-6 py-2 rounded-full border border-border-color lg:border-0 w-full lg:w-auto lg:grow lg:justify-around'>
