...
export function SearchBar() {
  ...
  return (
    <div className="w-full gap-3 flex flex-col mt-5 lg:flex-row lg:border lg:border-gray-300 lg:rounded-full lg:p-4 lg:w-4/5">
        <div className="relative flex items-center pl-8 py-4 rounded-full border border-gray-300 lg:border-0 lg:grow">
            <input className="flex items-center gap-10 relative w-full text-sm lg:w-auto lg:grow outline-0" placeholder="Buscar por ubicacion, restaurante" />
